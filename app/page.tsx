  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">TaskFlow Pro - Property Maintenance Orchestrator</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Streamlines maintenance request communication, scheduling, and workload balancing for property managers and landlords, reducing tenant frustration and team burnout.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust TaskFlow Pro - Property Maintenance Orchestrator.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} TaskFlow Pro - Property Maintenance Orchestrator. All rights reserved.</p>
