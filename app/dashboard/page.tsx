...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-8">Here's your TaskFlow Pro - Property Maintenance Orchestrator overview.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8">
          <a href="/dashboard/properties" className="block p-4 border rounded-lg hover:bg-blue-50 transition">
            ...
            <p className="text-sm text-gray-500">View and manage property portfolio</p>
          </a>
          <a href="/dashboard/maintenance" className="block p-4 border rounded-lg hover:bg-blue-50 transition">
            ...
            <p className="text-sm text-gray-500">Track and manage maintenance work</p>
          </a>
          <a href="/dashboard/reports" className="block p-4 border rounded-lg hover:bg-blue-50 transition">
            <h3 className="font-medium">Maintenance Reports</h3>
            <p className="text-sm text-gray-500">Generate maintenance performance insights</p>
          </a>
