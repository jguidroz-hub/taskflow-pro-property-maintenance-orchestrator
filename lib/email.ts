...
const FROM = process.env.EMAIL_FROM || 'TaskFlow Pro - Property Maintenance Orchestrator <noreply@example.com>';
const APP_NAME = 'TaskFlow Pro - Property Maintenance Orchestrator';
